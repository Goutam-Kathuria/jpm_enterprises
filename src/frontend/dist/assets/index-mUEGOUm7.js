...
var QueryClient = (_i = class {
  ...
  prefetchQuery(options2) {
    return this.fetchQuery(options2).then(noop$6).catch(noop$6);
  }
  ...
  prefetchInfiniteQuery(options2) {
    return this.fetchInfiniteQuery(options2).then(noop$6).catch(noop$6);
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: leftRef, className: "reveal", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-8", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-general text-sm text-muted-foreground mt-1", children: stat.label })
      ] }, stat.label)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: rightRef, className: "reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
...
function CollectionSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "collection", className: "py-24 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "reveal text-center mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-playfair text-4xl lg:text-5xl font-bold text-foreground mb-4", children: "Our Signature Collection" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-general text-muted-foreground max-w-xl mx-auto leading-relaxed", children: "Each piece is meticulously crafted using premium materials, blending timeless design with unparalleled comfort for the discerning homeowner." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: products.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            onMouseEnter: (e) => {
              e.currentTarget.style.boxShadow = "0 8px 40px oklch(0.65 0.12 75 / 0.2)";
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-playfair text-xl font-semibold text-foreground mb-2", children: product.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-general text-sm text-muted-foreground leading-relaxed mb-4", children: product.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
...
function ContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: leftRef, className: "reveal", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-playfair text-4xl lg:text-5xl font-bold text-foreground mb-6", children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-general text-secondary-foreground leading-relaxed mb-10", children: "Whether you have a specific design in mind or you're just beginning to explore, our team is here to guide you. Visit our showroom or reach out below." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 18, style: { color: "oklch(0.55 0.14 65)" } })
            }
          ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5",
              style: { background: "oklch(0.65 0.12 75 / 0.15)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 18, style: { color: "oklch(0.55 0.14 65)" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5",
              style: { background: "oklch(0.65 0.12 75 / 0.15)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 18, style: { color: "oklch(0.55 0.14 65)" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: rightRef, className: "reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
const options = [
  { label: "Size", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Maximize2, { size: 16 }) },
  { label: "Fabric", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 16 }) },
  { label: "Color", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { size: 16 }) },
  { label: "Style", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Palette, { size: 16 }) }
];
function CustomDesignSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "custom-design", className: "py-24 bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: leftRef, className: "reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-general text-secondary-foreground leading-relaxed mb-8", children: "Every home is unique, and so is every JPM sofa. We offer complete customization from the frame to the final stitch — crafted to your exact vision, your space, and your lifestyle." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mb-10", children: options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-8 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Crafting comfort and designing luxury since 2005. Premium handcrafted sofas made to last a lifetime."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: socialLinks.map(({ Icon: Icon2, label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href,
                target: "_blank",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { borderTop: "1px solid oklch(0.65 0.12 75 / 0.4)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
              ...
              children: [
                "© ",
                currentYear,
                " JPM Enterprises. All Rights Reserved."
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
              ...
              children: [
                "Built with ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.65 0.12 75)" }, children: "♥" }),
                " ",
                "using",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function GallerySection() {
  ...
  const prevImage = reactExports.useCallback(
    () => setLightboxIndex(
      (prev) => prev !== null ? (prev - 1 + images.length) % images.length : null
    ),
    []
  );
  const nextImage = reactExports.useCallback(
    () => setLightboxIndex(
      (prev) => prev !== null ? (prev + 1) % images.length : null
    ),
    []
  );
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "gallery", className: "py-24 bg-muted", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "reveal text-center mb-16", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-playfair text-4xl lg:text-5xl font-bold text-foreground mb-4", children: "Our Work in Beautiful Spaces" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-general text-muted-foreground max-w-lg mx-auto", children: "Explore how JPM furniture transforms living spaces into refined sanctuaries." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomIn, { size: 32, className: "text-white" })
                  }
                )
              ]
            },
    ...
    lightboxIndex !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/90", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "absolute bottom-6 left-1/2 -translate-x-1/2 font-general text-white/60 text-sm", children: [
        lightboxIndex + 1,
        " / ",
        images.length
      ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "hero-label font-general text-sm font-semibold tracking-[0.25em] uppercase mb-6",
              style: { color: "oklch(0.65 0.12 75)" },
              children: "Luxury Furniture Since 2005"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "hero-title font-playfair text-5xl sm:text-6xl lg:text-8xl font-bold leading-[1.05] text-white mb-6", children: [
            "Crafting Comfort.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "Designing Luxury." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-sub font-general text-lg sm:text-xl text-white/80 leading-relaxed mb-10 max-w-xl", children: "Experience the finest in handcrafted sofas and custom furniture. Where elegance meets comfort, and every piece tells a story." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-cta flex flex-wrap gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-general text-xs tracking-widest uppercase", children: "Scroll" }),
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      style: scrolled ? { borderBottom: "1px solid oklch(0.65 0.12 75 / 0.3)" } : {},
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden lg:flex items-center gap-8", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: () => handleNav(link.href),
              "data-ocid": `nav.${link.label.toLowerCase().replace(" ", "_")}_link`,
              className: `font-general text-sm font-medium tracking-wide relative group transition-colors duration-200 ${scrolled ? "text-foreground" : "text-white"}`,
              children: [
                link.label,
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `absolute -bottom-1 left-0 h-px transition-all duration-300 ${active === link.href ? "w-full" : "w-0 group-hover:w-full"}`,
                    style: { background: "oklch(0.65 0.12 75)" }
                  }
                )
              ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `lg:hidden fixed inset-0 top-20 bg-white/97 backdrop-blur-lg transition-all duration-300 ${menuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col items-center justify-center h-full gap-8", children: navLinks.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "li",
              {
...
function TestimonialsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "testimonials", className: "py-24 bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "reveal text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-playfair text-4xl lg:text-5xl font-bold text-foreground", children: "What Our Clients Say" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: { color: "oklch(0.65 0.12 75)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { size: 64, fill: "oklch(0.65 0.12 75)" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { border: "1px solid oklch(0.87 0.02 80)" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-playfair text-xl lg:text-2xl italic text-foreground leading-relaxed mb-8", children: [
                  '"',
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: testimonials[current].initials
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-playfair font-semibold text-foreground", children: testimonials[current].name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-general text-sm text-muted-foreground", children: testimonials[current].role })
                  ] })
                ] })
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-6 mt-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  background: i === current ? "oklch(0.65 0.12 75)" : "oklch(0.87 0.02 80)",
...
function eddsa(Point, cHash, eddsaOpts = {}) {
  ...
  function sign(msg, secretKey, options2 = {}) {
    ...
    const r = hashDomainToScalar(options2.context, prefix2, msg);
...
class ECDSAKeyIdentity extends SignIdentity {
   ...
   */
  static async generate(options2) {
    const { extractable = false, keyUsages = ["sign", "verify"], subtleCrypto } = options2 ?? {};
...
class DelegationChain {
   ...
   */
  static async create(from, to, expiration = new Date(Date.now() + 15 * 60 * 1e3), options2 = {}) {
    var _a2, _b2;
    const delegation = await _createSingleDelegation(from, to, expiration, options2.targets);
    return new DelegationChain([...((_a2 = options2.previous) == null ? void 0 : _a2.delegations) || [], delegation], ((_b2 = options2.previous) == null ? void 0 : _b2.publicKey) || from.getPublicKey().toDer());
  }
  /**
...
class IdleManager {
  ...
  constructor(options2 = {}) {
    ...
    const { onIdle, idleTimeout = 10 * 60 * 1e3 } = options2 || {};
    ...
    if (options2 == null ? void 0 : options2.captureScroll) {
      const scroll = debounce(_resetTimer, (options2 == null ? void 0 : options2.scrollDebounce) ?? 100);
...
class IdbKeyVal {
  ...
  static async create(options2) {
    const { dbName = AUTH_DB_NAME, storeName = OBJECT_STORE_NAME, version = DB_VERSION } = options2 ?? {};
...
class AuthClient {
  ...
  static async create(options2 = {}) {
    var _a2;
    const storage = options2.storage ?? new IdbStorage();
    const keyType = options2.keyType ?? ECDSA_KEY_LABEL;
    let key = null;
    if (options2.identity) {
      key = options2.identity;
    } else {
    ...
    let idleManager;
    if ((_a2 = options2.idleOptions) == null ? void 0 : _a2.disableIdle) {
      idleManager = void 0;
    } else if (chain || options2.identity) {
      idleManager = IdleManager.create(options2.idleOptions);
    }
    if (!key) {
      if (keyType === ED25519_KEY_LABEL) {
        ...
        if (options2.storage && keyType === ECDSA_KEY_LABEL) {
    ...
    return new this(identity, key, chain, storage, idleManager, options2);
  }
  ...
  async login(options2) {
    var _a2, _b2, _c2;
    const loginOptions = mergeLoginOptions((_a2 = this._createOptions) == null ? void 0 : _a2.loginOptions, options2);
  ...
  _getEventHandler(identityProviderUrl, options2) {
    return async (event) => {
      var _a2, _b2, _c2;
      ...
      switch (message.kind) {
        case "authorize-ready": {
          const request = {
            ...
            maxTimeToLive: options2 == null ? void 0 : options2.maxTimeToLive,
            allowPinAuthentication: options2 == null ? void 0 : options2.allowPinAuthentication,
            derivationOrigin: (_b2 = options2 == null ? void 0 : options2.derivationOrigin) == null ? void 0 : _b2.toString(),
            // Pass any custom values to the IDP.
            ...options2 == null ? void 0 : options2.customValues
          };
        ...
        case "authorize-client-success":
          try {
            await this._handleSuccess(message, options2 == null ? void 0 : options2.onSuccess);
          } catch (err) {
            this._handleFailure(err.message, options2 == null ? void 0 : options2.onError);
          }
          break;
        case "authorize-client-failure":
          this._handleFailure(message.text, options2 == null ? void 0 : options2.onError);
          break;
      }
    };
  }
  ...
  async logout(options2 = {}) {
    ...
    this._chain = null;
    if (options2.returnTo) {
      try {
        window.history.pushState({}, "", options2.returnTo);
      } catch {
        window.location.href = options2.returnTo;
      }
    }
  }
}
...
async function createAuthClient(createOptions) {
  ...
  const authClient = await AuthClient.create(options2);
  return authClient;
}
function InternetIdentityProvider({
  ...
  const login = reactExports.useCallback(() => {
    ...
    void authClient.login(options2);
