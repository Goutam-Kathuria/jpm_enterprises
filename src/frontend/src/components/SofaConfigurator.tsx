...
type Fabric = "Linen" | "Velvet" | "Leather" | "Microfiber" | "Cotton" | "Suede";
type Tone =
  | "Ivory"
  | "Charcoal"
  | "Sand"
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between px-4 py-3">
                          ...
                          {selected && <Check size={18} style={{ color: goldDark }} />}
                        </div>
                      </button>
                    );
                  })}
                ...
                <div className="space-y-10">
                  <div>
                    <div className="flex items-end justify-between mb-3">
                      ...
                      <p className="font-general text-2xl font-semibold" style={{ color: goldDark }}>
                  ...
                  >
                    ...
                    <p className="font-general text-base text-secondary-foreground">
                      Your sofa:{" "}
                      <span className="font-semibold" style={{ color: goldDark }}>
                        {formatCentimeters(width)}
                      </span>{" "}
                      wide x{" "}
                      <span className="font-semibold" style={{ color: goldDark }}>
