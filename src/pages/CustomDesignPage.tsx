...
export function CustomDesignPage() {
  ...
  const selectedProduct = search.product
    ? search.product
        .split("-")
      ...
      <main>
        ...
        >
          <div className="max-w-3xl mx-auto px-6">
            ...
            {selectedProduct ? (
              <p
                className="mt-5 inline-flex rounded-full px-4 py-2 font-general text-xs font-semibold uppercase tracking-[0.18em]"
                style={{
                  background: "oklch(0.65 0.12 75 / 0.1)",
                  color: "oklch(0.55 0.14 65)",
                }}
              >
                Starting from: {selectedProduct}
              </p>
            ) : null}
          </div>
        </section>
